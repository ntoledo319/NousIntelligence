...
CORE_BLUEPRINTS = [
    ...
    {'name': 'therapeutic', 'module': 'routes.therapeutic_routes', 'attr': 'therapeutic_bp', 'url_prefix': None},
    {'name': 'tasks_v1', 'module': 'routes.task_routes', 'attr': 'task_bp', 'url_prefix': None},
    {'name': 'integrations', 'module': 'routes.integration_routes', 'attr': 'integration_bp', 'url_prefix': None},
