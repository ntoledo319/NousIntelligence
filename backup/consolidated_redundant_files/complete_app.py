"""
NOUS Personal Assistant - Complete Application
...
# Set up CORS headers for all responses - critical for public access
@app.after_request
...
def page_not_found(e):
    return render_template('error.html', error=str(e), code=404, title="Page Not Found"), 404

@app.errorhandler(500)
def server_error(e):
    logger.error(f"Server error: {str(e)}")
    return render_template('error.html', error="Internal server error", code=500, title="Server Error"), 500
