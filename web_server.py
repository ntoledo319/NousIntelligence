"""
NOUS Web Server - Simple Flask Application

This is a simplified Flask server that will override the Replit default page.
"""
...
# Create Flask app
app = Flask(__name__)
app.secret_key = os.environ.get("SESSION_SECRET", "nous-secure-key")
