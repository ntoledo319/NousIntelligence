#!/bin/bash
# NOUS Personal Assistant - Public Deploy Script
# Configured for public access with Replit deploy button
...
log_message "INFO: Starting NOUS deployment (Public Access Mode)"
...
# Set required environment variables for public access
...
log_message "INFO: Starting application with gunicorn in public mode"
exec gunicorn \
    --bind 0.0.0.0:$PORT \
    --workers 2 \
    --timeout 120 \
