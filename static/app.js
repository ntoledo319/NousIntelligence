...
class ChatApp {
  ...
  async callChatAPI(message) {
    ...
    const endpoints = [this.config.apiEndpoint, this.config.legacyApiEndpoint].filter(Boolean);
  ...
  showCrisisSupport() {
    ...
    const messagesContainer =
      document.getElementById('message-stream') || document.querySelector('.chat-messages');
...
ChatApp.prototype.trackActivity = function (
  activityType,
