...
class TestFamilyService(BaseTestCase):
    """Test family service"""
    ...
    def test_create_success(self, service, mock_repository):
        ...
        expected = {'id': '1', 'name': 'New family', 'user_id': 'user123'}
    ...
    def test_update_success(self, service, mock_repository):
        ...
        expected = {'id': '1', 'name': 'Updated family'}
