...
from src.application.services.thought_service import ThoughtService
from src.infrastructure.error_handling import ValidationError, NotFoundError

class TestThoughtService(BaseTestCase):
    ...
    def test_create_success(self, service, mock_repository):
        ...
        # Arrange
        data = {'name': 'New thought'}
        expected = {'id': '1', 'name': 'New thought', 'user_id': 'user123'}
    ...
    def test_update_success(self, service, mock_repository):
        ...
        # Arrange
        data = {'name': 'Updated thought'}
        expected = {'id': '1', 'name': 'Updated thought'}
